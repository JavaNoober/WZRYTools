...
public class BaseAccessibilityService extends AccessibilityService {
    ...
    private static BaseAccessibilityService instance;

    public void init(Context context) {
        this.context = context.getApplicationContext();
        accessibilityManager =
                (AccessibilityManager) this.context.getSystemService(Context.ACCESSIBILITY_SERVICE);
    }

    public static BaseAccessibilityService getInstance() {
        if (instance == null) {
            instance = new BaseAccessibilityService();
        }
        return instance;
    }
    ...
    public void onCreate() {
        super.onCreate();
//        init(ApplicationKtLike.getContext());
    }
    ...
    public AccessibilityNodeInfo findViewByText(String text, boolean clickable) {
        return findViewByText(getRootInActiveWindow(),text,clickable);
    }

    public AccessibilityNodeInfo findViewByText(AccessibilityNodeInfo info, String text,
                                                boolean clickable) {
        if (info == null) {
            return null;
        }
        ...
        if (nodeInfoList != null && !nodeInfoList.isEmpty()) {
            for (AccessibilityNodeInfo nodeInfo : nodeInfoList) {
                if (nodeInfo != null && (nodeInfo.getText() != null && text.equals(
                        nodeInfo.getText().toString()) && nodeInfo.isClickable() == clickable)) {
                    return nodeInfo;
                }
            }
        }
